...
namespace WebApp.Command.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public async Task<IActionResult> CreateFile(int type)
        {
            ...
            switch (fileType)
            {
                ...
                case EFileType.Pdf:
                    ...
                    PdfFile<Product> pdfFie = new(products, HttpContext);


                    fileCreateInvoker.SetCommand(new CreatePdfTableActionCommand<Product>(pdfFie));
        ...
        public async Task<IActionResult> CreateFiles()
        {
            ...
            fileCreateInvoker.AddCommand(new CreatePdfTableActionCommand<Product>(pdfFie));
